...
/** useScrollSpy — P-CO-3.2 (2026-05-16). Self-contained window-scroll
 * copy (DashboardShell scrolls the document). Same as the other
 * hubs — kept local so صحّة المنصّة stays decoupled. */
